...
(function ($) {
        ...
        $(document).ready(function () {
            $(".add-wishlist").click(function () {
                ...
                $.ajax({
                    ...
                    url: '/add_wishlist/?user_id=' + userId + '&product_id=' + productId, // Include data in the URL
    ...
    // });
        ...
        //                 document.getElementById("amount").innerText = data.amount.toFixed(3);
        //                 document.getElementById("total_amt").innerText = data.totalamount.toFixed(2);
        //             }
        //         })
        // });
        ...
        // edit by supriya 22 sept 
        $(document).ready(function () {
             // Add a click event listener to the "plus-cart" button
            $('.plus-cart').click(function () {
                ...
                $.ajax({
                    ...
                    url: '/pluscart/', // Replace with your server-side script URL
                    data: {
                    ...
                    success: function (data) {
                        ...
                        // $('#amount').text(data.amount.toFixed(3));
                        // $('#total_amt').text(data.totalamount.toFixed(2));
                        if (data.success) {
                            // Update the total amount and other elements based on the server response
                            $('#total_amt').text('Rs.' + data.totalamount.toFixed(2));
                        } else {
            ...
            // Add a click event listener to the "minus-cart" button
            $('.minus-cart').click(function () {
                var quantityDisplay = $(this).siblings('.quantity-display');
                var currentQuantity = parseInt(quantityDisplay.text());
                ...
                if (currentQuantity > 1) {
                    ...
                    $.ajax({
                        type: 'POST', // Use POST or GET as needed
                        url: '/minuscart/', // Replace with your server-side script URL
                        data: {
                            product_id: $(this).attr('pid'),
                            quantity: currentQuantity
                        },
